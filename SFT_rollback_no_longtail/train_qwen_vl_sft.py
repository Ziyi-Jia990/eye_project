...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data-csv", type=str, default="/mnt/hdd/jiazy/eye_project/eye_project/trans_txt/description.cleaned.csv")
    parser.add_argument("--prompt-path", type=str, default="/mnt/hdd/jiazy/eye_project/SFT_rollback_no_longtail/prompt.txt")
    parser.add_argument("--images-root", type=str, default="")
    parser.add_argument("--output-dir", type=str, default="/mnt/hdd/jiazy/eye_project/SFT_rollback_no_longtail/outputs/qwen_retina_lora_no_longtail")
    parser.add_argument("--splits-dir", type=str, default="/mnt/hdd/jiazy/eye_project/SFT_rollback_no_longtail/splits")
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="Weight for the plain diagnosis multi-label BCE loss.",
    )
    parser.add_argument(
        "--diag-pooling",
        type=str,
...
class RetinaMultiTaskTrainer(Trainer):
    def __init__(
        ...
        *args,
        ...
        loss_weight_diag_text_ce: float = 1.0,
        loss_weight_diag_bce: float = 0.5,
        ...
        **kwargs,
        ...
        self.loss_weight_diag_bce = loss_weight_diag_bce
    ...
    def _forward_multitask(
        ...
        diag_logits = None
        loss_diag_bce = outputs.logits.new_zeros(())
        if diagnosis_targets.shape[-1] > 0:
            ...
            loss_diag_bce = torch.nn.functional.binary_cross_entropy_with_logits(
                diag_logits,
        ...
        total_loss = (
            ...
            + self.loss_weight_diag_bce * loss_diag_bce
        )
        return total_loss, {
...
def main() -> None:
    ...
    if diagnosis_labels:
        print(
            "[info] Rollback diagnosis auxiliary loss: "
            f"plain BCE with weight={args.loss_weight_diag_bce}."
        )
    ...
    trainer = RetinaMultiTaskTrainer(
        ...
        loss_weight_diag_bce=args.loss_weight_diag_bce,
